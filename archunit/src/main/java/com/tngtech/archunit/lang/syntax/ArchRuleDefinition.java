...
public final class ArchRuleDefinition {
    ...
    public static final class Creator {
        ...
        public GivenFields fields() {
            return new GivenFieldsInternal(priority, new ClassesToFieldsTransformer());
        }

        @PublicAPI(usage = ACCESS)
        public GivenFields noFields() {
            return new GivenFieldsInternal(priority,
                    new ClassesToFieldsTransformer().as("no fields"),
